...
public class MusicPlayer extends JFrame {
	...
	public MusicPlayer() {
		...
		btnPrevious.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//If previous button is hit on first song got to last song
				...
				hit = new Media(new File("src/main/files/Music/" + list.getSelectedItem()).toURI().toString());					mediaPlayer = new MediaPlayer(hit);
		...
		File folder = new File("src/main/files/Music/");
		...
		btnNext.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				hit = new Media(new File("src/main/files/Music/" + list.getSelectedItem()).toURI().toString());
	...
	public void init() {
		...
		hit = new Media(new File("src/main/files/Music/" + songList.getSelectedItem()).toURI().toString());
		mediaPlayer = new MediaPlayer(hit);
